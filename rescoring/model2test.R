...
d=read.csv(ifelse(substr(t,1,3)=="tst",sprintf("../%s-yxi.csv",t),sprintf("../pdbbind-%s-trn-yxi.csv",v))) # d[1] is pbindaff in pKd unit, d[2] to d[6] are Vina's 5 unweighted terms, d[7] and d[8] are N(ActTors) and N(InactTors).
